...
public class StartUpJobs extends Job{
	...
	public String consumer() throws JMSException{
		...
		Destination dest = new StompJmsDestination("/queue/90645.book.orders");//destination);

		MessageConsumer consumer = session.createConsumer(dest);
		//System.out.println(.toString());

		System.out.println("Waiting for messages from " + "/queue/90645.book.orders" + "...");
	...
	void doposting(String str)
	{
		try {
			...
			String input="{\"id\" :\"90645\",\"order_book_isbns\":["+str+"]}";
...

    	{
    		ArrayList<String> library=new ArrayList<String>();
    			...
    			WebResource webResource=client.resource("http://54.215.133.131:9000/orders/90645");
    	...
    	public void publisher(ArrayList<String>books) throws JMSException
    	{
    		...
    		String host = "54.215.133.131";
    		int port = Integer.parseInt("61613");
    		String destination_a = "/topic/90645.book.all";
    		String destination_b="/topic/90645.book.computer";
